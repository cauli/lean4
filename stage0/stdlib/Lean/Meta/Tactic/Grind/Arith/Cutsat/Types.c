...
v___x_961_ = lean_alloc_ctor(0, 24, 2);
...
lean_ctor_set(v___x_961_, 15, v___x_957_);
lean_ctor_set(v___x_961_, 16, v___x_955_);
lean_ctor_set(v___x_961_, 17, v___x_959_);
lean_ctor_set(v___x_961_, 18, v___x_954_);
lean_ctor_set(v___x_961_, 19, v___x_959_);
lean_ctor_set(v___x_961_, 20, v___x_960_);
lean_ctor_set(v___x_961_, 21, v___x_959_);
lean_ctor_set(v___x_961_, 22, v___x_959_);
lean_ctor_set(v___x_961_, 23, v___x_959_);
lean_ctor_set_uint8(v___x_961_, sizeof(void*)*24, v___x_956_);
lean_ctor_set_uint8(v___x_961_, sizeof(void*)*24 + 1, v___x_956_);
return v___x_961_;
}
}
